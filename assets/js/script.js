...
function searchJobs(){
    var searchApi = "https://www.googleapis.com/customsearch/v1?key=AIzaSyDN1URsMNvO298DwJn6yW7QN8FC-uaAe-U&cx=261baf09873055c10&q=" + jobSearch.value + locationSearch.value
...
function displaySearchResults(arr){
    ...
    for (i = 0; i < arr.length; i++){
        ...
        jobTitleText.innerHTML = "<a href='" + arr[i].link + "'>" + arr[i].title + "</a>";
